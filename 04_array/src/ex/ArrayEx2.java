...
public class ArrayEx2 {
	...
	/**
	 * 얕은 복사 - 참조형 변수가 가지고 있는 "주소" 만 복사하는 것!!
	 * 
	 * - 서로 다른 변수가 같은 배열/객체를 참조하기 때문에 같은 값을 공유!!!
	 * 
	 */
	...
	/**
	 * 깊은 복사 -원본 배열/객체가 가지고 있는 값을 똑같이 복사한 배열/객체를 만드는것 (복제의 개념)
	 * 
	 * -새로운 배열/객체가 만들어 지는 것으로 원본과는 독립되어 있음 -> 값을 공유하지 않음 !!
	 * 
	 */
	public void method2() {
		// 원본 배열
	 ...
	 * 향상된 for문 (forEach)
	 * 
	 * - 0번 인덱스 부터 마지막 인덱스 까지 1씩 증가하면 iterable 성격을 띄는 객체의 요소를 하나씩 순서대로 반환하는 for문
	 * 
	 * (iterble : 반복가능한) ex) 배열, List, Set, Map 등
	 * 
	 * [작성법]
	 * 
	 * for(배열 요소자료형의 변수 :배열명){
	 * 
	 * }
	 * 
	 ...
	 * for(int num : arr ){
	 * 
	 * // num은 for문이 반복 될때 마ㄱㅏ arr[0], arr[1], arr[2], 인덱스 값이 순차 적으로 대입됨
	 * 
	 * }
	 */
