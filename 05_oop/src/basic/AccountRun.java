...
public class AccountRun {
	...
	//	System.out.println("a1 잔액 : " + a1.balance);
		...
		// 입금 기능 호출
		a1.deposit(5000); // a1이 참하는 잔액을 5000원 추가
		...
		System.out.println(a == b); // false (동일 비교)
		System.out.println(a.equals(b) ); //true (동등 비교)	
		
		System.out.println("==========================================");
		System.out.println("[출금 기능]");
		
		a1.withdraw("zxcva", 20000); // 비밀번호 불일치
