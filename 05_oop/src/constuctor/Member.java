...
public class Member {
	...
	public Member() {
		...
		//Member 객체가 생성될때 Println()구문을 수행
...
//		private void method() {}// 접근 제한자 달라도 -> 중복
//		public String method() {}반환형이 다름 -> 중복
		
		/*오버로딩 (Overloding, 과적)
		 * - 하나의 클래스에 동일한 이름의 매서드를 여러 개 작성하는 기법
		 * 
		 ...
		 *  오버로딩 성립 조건
		 *  1) 매서드의 이름이 똑같아야 한다
		 *  2) 매개 변수의 개수 자료형의 순서 , 자료형 중 하나라도 달라야 한다.
		 *  */
