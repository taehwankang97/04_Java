...
public class Student {
	...
	public static final int MAX_VALUE = 100;// 스킬역량 최대값
	
	//필드 2 - instance 변수 
	// -> new 연산자에 의해서 생성된 객체(intance)의 변수
	...
	// getter/setter 자동완선 : alt + shift + s -> r
	// 객체의 필드 값을 반환하는 메서드
	
	public String toString() {
		
		// 240001 / 홍길동 / 남 / java : 80 / hmtml : 70
		
		//String String.format("패턴", 값)
		//-> 패턴 형태의 문자열을 반환하는 메서드
		//(printf와 비슷한데 printf는 출력,
		// String.fotma()dms 문자열 만들어서 반환)
