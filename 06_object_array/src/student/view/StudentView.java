...
public class StudentView {
	 ...
	 * 학생 추가 화면
	 * 
	 * 학번, 이름, 성별을 입력 받아 Student 객체로 만들어서 StudentService로 전달! -> 추가 성공 시 true/ 실패 시
	 * false 반환 받아 결과 출력
	 */
	private void addStudent() {
		...
		// StudetnsService 객체의 addStudent() 호출후
		// 결과 반환 받기
	...
	/**
	 * studentService에 있는 students 객체를 받아와 모든 학생 정보 출력
	 */
	private void allStudent() {
		...
		for (StudentDTO std : students) {
			...
			// (참조 변수가 null을 저장하고 있는데 사용하려고 할때)
			if (std == null)
				return;
	...
	/**
	 * 인덱스의 번호를 입력 받아 일치하는학생의 html, css, js, java 점수 수정
	 * 
	 * 단, 입력된 인덱스 사 0 미만 student 배열 마지막 인덱스 초과 한 경우 인덱스 범위가 올바르지 않습니다.(1)
	 * 
	 * 정상 범위 인덱스이지만 학생이 존재하지 않는 경우 "해당 인덱스에 학생 정보가 존재하지 않습니다" 출력 (2)
	 * 
	 * 정상(3)
	 */
	private void updateIndex() {
		...
		/* 학생이 존재하는 경우 */
		// HTML, CSS, JS, Java 순서로 점수 입력 : 100 90 80 70
	 ...
	 * 
	 * ex) 인덱스 입력 : 0 =============================================== 이름 : 짱구
	 * HTML(80) CSS(70) JS(50) Java(90); 합계 : 290 평균 : 72.5
	 * ===============================================
	 */
