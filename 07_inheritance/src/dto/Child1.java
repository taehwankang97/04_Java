...
public class Child1 extends parent {
	...
	public Child1() {
		super();
		System.out.println("자식1 - 기본생성자로 객체 생성");
	}
	...
	public void print() {
		...
		// private vlfem 간접접근
		System.out.println("address : " + getAddress());// private 간접접근
		System.out.println("money : " + getMoney() );// private 간접접근
		System.out.println("car : " + getCar() );// private 간접접근
	...
	public String childInform() {
		//return String.format("%s/%s/%s/%s/%s", lastName, getAddress(), getMoney(), getCar(), notebook);
	...
	//Prant에게 상속받은 toString()오버라이딩
	@Override
	public String toString() {
		//Child1 클래스 내부에서 toString()호출하면
		//Child1.toString()이 호출됨
		
		// super.toStting() : 부모 클래스에 작성된 toString()호출
		//-> 오버라이딩 했다고 해서
		//	 부모의 메서드가 덮어쓰기가 되어 사라지는것이 아니다
