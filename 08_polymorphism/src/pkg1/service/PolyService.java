...
public class PolyService {
	...
	public void test3() {
		...
		Parent p3 = new Child(); // 부모 = 자식
		
		System.out.println(p1.toString()); //Parent.toSrting()
