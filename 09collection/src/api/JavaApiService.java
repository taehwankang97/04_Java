...
public class JavaApiService {
	 ...
	 * 
	 * 2) String s2 = new String("word"); // new 연산자 이용방법
	 ...
	 * 
	 * ex) String srt = "abc"; "abc" / 참조 주소 : 0x100
	...
	public void test1() {
		...
		t.setNum(200);
		t.setSrt("Apple");
		System.out.println("변경후 TestDTO : " + System.identityHashCode(t));
		 ...
		 * Constant pool 확인
		 * 
		 * - "" String 리터럴 표기법을 이용해 생성도니 String 객체가
		 * 	저장되는 Heap 내부 영역 
		 * 
		 * - 동일한 문자열을 생성해게 되는 경우 
		 * 	 객체가 새롭게 생성되지 않고 
	...
	public void test2() {
		...
		// == s1, s3의 값이 다르기 때문에
		// 	비교연산 시 무조건 False
		//System.out.println("s1 == s3 " + (s1.equals(s3) s3));
	...
	public void test4() {
		...
		System.out.println("[아무 단어 / 문장 5번 입력]");
