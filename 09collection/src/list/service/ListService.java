...
public class ListService {
	...
	public void test2() {
		...
		/*
		 * 제네릭 (generics -> <제한 타입>) 1) 컬렉션의 타입을 제한하여 한가지 자료형만 저장할 수 있게하는 기능
		 * 
		...
		String before = menuList.set(3, "꼬냑");

		System.out.println(before + "을 " + menuList.get(3) + "으로 주종강화 시킴");
		System.out.println(menuList);

		// 6. boolean contains(E e)
		// - List에 내부에 e와 같은 객체가
		// 존재하면 true, 없으면 false 반환 (확인 기능)
		System.out.println("럼 : " + menuList.contains("럼"));
		System.out.println("막걸리 : " + menuList.contains("막걸리"));
		...
		System.out.println("고량주 : " + menuList.indexOf("고량주"));
		System.out.println("동동주 : " + menuList.indexOf("동동주"));

		// 8. E remove(int index)
		// - List에서 지정된 index번째 요소를 제거
		// -> 중간이 제거 되면 뒤쪽 요소를 앞으로 이동됨
		// -> 제거된 요소는 메서드 결과로 반환됨
...
//			System.out.println(list.get(i));
		...
		System.out.println("생성 완료 _ 걸린시간 " + (end - start) + "ms");
