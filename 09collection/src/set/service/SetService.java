...
public class SetService {
	...
	/**
	 * Set에 저장된 객체를 꺼내는 방법 1. Iterator(반복자) 이용 2. List로 변환 3. 향상된 for문 이용
	 */
	public void test2() {
	 ...
	 * 
	 * 1. Object.equals() 오버라이딩 하기 2. Object.hashCode() 오버라이딩 하기
	 * 
	 * *** 1,2 둘다 수행 해야만함! *** -> Java는 동일한 객체임을 비교할 때 동등(equals)/(hashCode)동일 모두
	 * true여야지만 동일한 객체로 인식한다
	 */
	public void test3() {
	 ...
	 * 
	 * ** 선행 조건 ** - 저장되는 객체가 Comparable 인터페이스를 상속해 구현해야함
	 */
	public void test4() {
		// 로또 번호 생성기
