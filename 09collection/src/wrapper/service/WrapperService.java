...
//-> String, Warpper Class등
//*- 미작성시 컴파일러가 자동으로 추가해줌
...
public class WrapperService {
	...
	public void test1() {
		...
		/*int 자료형을 저장하는 List(Collectoin)*/
//		List<int> list = new ArrayList<int>();
		//-> 제네릭에 기본자료형 작성시 오류 발생
	...
	public void test2() {
		...
		// 보동 String 형태로 전달되러져서 오는 경우가 많다
		...
		//방법 2) Wrapper Classd의 valueOf()/toString() 이용하기
